...
└──────────────────────────────┬──────────────────────────────┘
                               ...
                               ▼
┌─────────────────────────────────────────────────────────────┐
│ 📦 Выходные артефакты (программная генерация):              │
│    1. Презентация_ИИ_Агенты_ГазпромНефть (.pptx / .pdf)     │
│    2. Полный иллюстрированный отчет (.docx / .pdf)          │
...
cd projects/01_мультиагентный_конвейер_стратегии_газпром
python -m venv venv
# Windows:
